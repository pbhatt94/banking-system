...
public class IssueDAO extends GenericDAO<Issue> {
	...
	public Issue getIssueById(String issueId) throws ClassNotFoundException, SQLException {
		String query = String.format("SELECT * FROM %s WHERE %s = '%s'", 
				IssueConstants.ISSUE_TABLE_NAME,
				IssueConstants.ISSUE_ID_COLUMN,
				issueId
				);
		return get(query);
	}
	...
	public boolean addIssue(Issue issue) throws ClassNotFoundException, SQLException {
		String query = String.format(
		        ...
		        IssueConstants.ISSUE_TABLE_NAME,
		        IssueConstants.ISSUE_ID_COLUMN,
		        IssueConstants.MESSAGE_COLUMN,
		        IssueConstants.USER_ID_COLUMN,
		        IssueConstants.STATUS_COLUMN,
		        IssueConstants.CREATED_AT_COLUMN,
		        issue.getIssueID(),
		        issue.getMessage(),
		        issue.getUserId(),
		        issue.getStatus().toString(), 
